...
export default function IconSidebar({ items = [], mobile = false }) {
  ...
  return (
    <div
      ...
      className="fixed left-0 top-0 h-screen w-[72px] flex flex-col items-center py-4 backdrop-blur-md bg-black/30 border-r border-white/10 z-40"
    >
      {/* LOGO */}
      <div
